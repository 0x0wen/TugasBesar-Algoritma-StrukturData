...
main: $(OBJ_MESINKAR) $(OBJ_MESINWORD) $(OBJ_MESINSENTENCE) $(OBJ_TIME_ADT) $(OBJ_DATETIME) $(OBJ_LISTDINAMIS) $(OBJ_INISIALISASI) $(OBJ_FOTOPROFIL) $(OBJ_BALASAN) $(OBJ_CMDBALASAN) $(OBJ_UTAS) $(OBJ_TABUTAS) $(OBJ_CMDUTAS) $(OBJ_KICAUAN) $(OBJ_TABKICAUAN) $(OBJ_CMDKICAUAN) $(OBJ_DRAFKICAUAN) $(OBJ_CMDDRAFKICAUAN) $(OBJ_TEMAN) $(OBJ_CMDTEMAN) $(OBJ_PERMTMAN) $(OBJ_CMDPERMTMAN) $(OBJ_CMDPENGGUNA) $(OBJ_TABPENGGUNA) $(OBJ_GLOBAL) $(OBJ_MAIN)
	$(CC) $(CFLAGS) -o $@ $^
...
clean:
	rm -f main *.o $(OBJ_MESINKAR) $(OBJ_MESINWORD) $(OBJ_MESINSENTENCE) $(OBJ_TIME_ADT) $(OBJ_DATETIME) $(OBJ_LISTDINAMIS) $(OBJ_INISIALISASI) $(OBJ_FOTOPROFIL) $(OBJ_BALASAN) $(OBJ_CMDBALASAN) $(OBJ_UTAS) $(OBJ_TABUTAS) $(OBJ_CMDUTAS) $(OBJ_KICAUAN) $(OBJ_TABKICAUAN) $(OBJ_CMDKICAUAN) $(OBJ_DRAFKICAUAN) $(OBJ_CMDDRAFKICAUAN) $(OBJ_TEMAN) $(OBJ_CMDTEMAN) $(OBJ_PERMTMAN) $(OBJ_CMDPERMTMAN) $(OBJ_CMDPENGGUNA) $(OBJ_PENGGUNA) $(OBJ_TABPENGGUNA) $(OBJ_GLOBAL) $(OBJ_MAIN)
...
void BALAS(int IDKicau, int IDBalasan)
{
    ...
    else if (isFriend(matrixTeman, ID_PENGGUNA(penggunaSekarang), PENULIS_BALASAN(*searchBalasan(searchKicauan(dataKicauan, IDKicau), IDBalasan))) == false && PRIVASI_PENGGUNA(*searchPengguna(dataPengguna, IDKicau)))
    {
